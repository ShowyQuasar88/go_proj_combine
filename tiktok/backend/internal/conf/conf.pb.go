...
type Security struct {
	...
	// JWT
	JwtSecret        string `protobuf:"bytes,4,opt,name=jwtSecret,proto3" json:"jwtSecret,omitempty"`                // JWT密钥
	JwtExpire        int32  `protobuf:"varint,5,opt,name=jwtExpire,proto3" json:"jwtExpire,omitempty"`               // JWT过期时间(秒)
	JwtRefreshExpire int32  `protobuf:"varint,6,opt,name=jwtRefreshExpire,proto3" json:"jwtRefreshExpire,omitempty"` // 刷新token过期时间(秒)
}
...
func (x *Security) GetJwtExpire() int32 {
	if x != nil {
		return x.JwtExpire
	}
	return 0
...
func (x *Security) GetJwtRefreshExpire() int32 {
	if x != nil {
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0xc0, 0x01, 0x0a, 0x08, 0x53, 0x65, 0x63, 0x75, 0x72, 0x69, 0x74, 0x79, 0x12, 0x16, 0x0a, 0x06,
	...
	,
