...
type Bootstrap struct {
	...
	Trace    *Trace    `protobuf:"bytes,3,opt,name=trace,proto3" json:"trace,omitempty"`       // 添加链路追踪配置
	Log      *Log      `protobuf:"bytes,4,opt,name=log,proto3" json:"log,omitempty"`           // 添加日志配置
	Security *Security `protobuf:"bytes,5,opt,name=security,proto3" json:"security,omitempty"` // 添加安全配置
}
...
type Trace struct {
	...
	Endpoint    string  `protobuf:"bytes,1,opt,name=endpoint,proto3" json:"endpoint,omitempty"`       // 链路追踪收集器地址
	Sampler     float64 `protobuf:"fixed64,2,opt,name=sampler,proto3" json:"sampler,omitempty"`       // 采样率
	Environment string  `protobuf:"bytes,3,opt,name=environment,proto3" json:"environment,omitempty"` // 环境标识(dev/prod等)
}
...
type Log struct {
	...
	Filename   string `protobuf:"bytes,2,opt,name=filename,proto3" json:"filename,omitempty"`      // 日志文件路径
	MaxSize    int32  `protobuf:"varint,3,opt,name=maxSize,proto3" json:"maxSize,omitempty"`       // 单个日志文件最大大小(MB)
	MaxAge     int32  `protobuf:"varint,4,opt,name=maxAge,proto3" json:"maxAge,omitempty"`         // 日志保留天数
	MaxBackups int32  `protobuf:"varint,5,opt,name=maxBackups,proto3" json:"maxBackups,omitempty"` // 保留的旧日志文件个数
}
...
type Security struct {
	...
	AesKey     string        `protobuf:"bytes,1,opt,name=aesKey,proto3" json:"aesKey,omitempty"`          // AES 加密密钥
	AesIv      string        `protobuf:"bytes,2,opt,name=aesIv,proto3" json:"aesIv,omitempty"`            // AES 初始化向量
	BcryptCost int32         `protobuf:"varint,3,opt,name=bcryptCost,proto3" json:"bcryptCost,omitempty"` // bcrypt 加密成本
	Jwt        *Security_Jwt `protobuf:"bytes,4,opt,name=jwt,proto3" json:"jwt,omitempty"`
}
...
func (x *Security) GetAesKey() string {
	if x != nil {
		return x.AesKey
	}
	return ""
...
func (x *Security) GetAesIv() string {
	if x != nil {
		return x.AesIv
	}
	return ""
...
func (x *Security) GetBcryptCost() int32 {
	if x != nil {
		return x.BcryptCost
	}
	return 0
...
type Security_Jwt struct {
	...
	Secret        string `protobuf:"bytes,1,opt,name=secret,proto3" json:"secret,omitempty"`                // JWT密钥
	Expire        int32  `protobuf:"varint,2,opt,name=expire,proto3" json:"expire,omitempty"`               // JWT过期时间(秒)
	RefreshExpire int32  `protobuf:"varint,3,opt,name=refreshExpire,proto3" json:"refreshExpire,omitempty"` // 刷新token过期时间(秒)
}
...
func (x *Security_Jwt) GetExpire() int32 {
	if x != nil {
		return x.Expire
	}
	return 0
...
func (x *Security_Jwt) GetRefreshExpire() int32 {
	if x != nil {
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x05, 0x74, 0x72, 0x61, 0x63, 0x65, 0x12, 0x21, 0x0a, 0x03, 0x6c, 0x6f, 0x67, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69,
	0x2e, 0x4c, 0x6f, 0x67, 0x52, 0x03, 0x6c, 0x6f, 0x67, 0x12, 0x30, 0x0a, 0x08, 0x73, 0x65, 0x63,
	0x75, 0x72, 0x69, 0x74, 0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x6b, 0x72,
	0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x53, 0x65, 0x63, 0x75, 0x72, 0x69, 0x74,
	0x79, 0x52, 0x08, 0x73, 0x65, 0x63, 0x75, 0x72, 0x69, 0x74, 0x79, 0x22, 0xb8, 0x02, 0x0a, 0x06,
	...
	0x77, 0x6f, 0x72, 0x64, 0x12, 0x3c, 0x0a, 0x0c, 0x72, 0x65, 0x61, 0x64, 0x5f, 0x74, 0x69, 0x6d,
	...
	0x75, 0x74, 0x22, 0x5f, 0x0a, 0x05, 0x54, 0x72, 0x61, 0x63, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x65,
	...
	0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x01, 0x52, 0x07, 0x73, 0x61, 0x6d, 0x70, 0x6c, 0x65,
	0x72, 0x12, 0x20, 0x0a, 0x0b, 0x65, 0x6e, 0x76, 0x69, 0x72, 0x6f, 0x6e, 0x6d, 0x65, 0x6e, 0x74,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x65, 0x6e, 0x76, 0x69, 0x72, 0x6f, 0x6e, 0x6d,
	0x65, 0x6e, 0x74, 0x22, 0x89, 0x01, 0x0a, 0x03, 0x4c, 0x6f, 0x67, 0x12, 0x14, 0x0a, 0x05, 0x6c,
	...
	,
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Security_Jwt)(nil),        // 10: kratos.api.Security.Jwt
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	10, // 9: kratos.api.Security.jwt:type_name -> kratos.api.Security.Jwt
